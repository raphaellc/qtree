...
public class QuadTree {
    ...
    //constuctor
    public QuadTree(Rectangle boundary, int _capacity) {
    ...
    public void subdivide() {
        ...
        this.northwest = new QuadTree(new Rectangle(this.x - halfwidth, this.y + halfheight, halfwidth, halfheight),this.capacity);
        this.northeast = new QuadTree(new Rectangle(this.x + halfwidth, this.y + halfheight, halfwidth, halfheight),this.capacity);
        this.southwest = new QuadTree(new Rectangle(this.x - halfwidth, this.y - halfheight, halfwidth, halfheight),this.capacity);
        this.southeast = new QuadTree(new Rectangle(this.x + halfwidth, this.y - halfheight, halfwidth, halfheight),this.capacity);
